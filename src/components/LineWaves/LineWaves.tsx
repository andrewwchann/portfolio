/**
 * Line Waves — from React Bits (https://reactbits.dev/backgrounds/line-waves)
 * MIT — DavidHDev/react-bits
 */
...
export default function LineWaves({
  ...
  return <div ref={containerRef} className="line-waves-container" aria-hidden />;
}
